import { createHotContext as __vite__createHotContext } from "/@vite/client";import.meta.hot = __vite__createHotContext("/node_modules/@sveltejs/kit/src/runtime/client/client.js");import { DEV } from '/node_modules/.vite/deps/esm-env.js?v=c4d5c7f4';
import { onMount, tick } from '/node_modules/.vite/deps/svelte.js?v=c4d5c7f4';
import {
	make_trackable,
	decode_pathname,
	decode_params,
	normalize_path,
	add_data_suffix
} from '/node_modules/@sveltejs/kit/src/utils/url.js?v=c4d5c7f4';
import {
	find_anchor,
	get_base_uri,
	get_link_info,
	...
	is_external_url,
	scroll_state
} from '/node_modules/@sveltejs/kit/src/runtime/client/utils.js?v=c4d5c7f4';
import * as storage from '/node_modules/@sveltejs/kit/src/runtime/client/session-storage.js?v=c4d5c7f4';
import {
	lock_fetch,
	unlock_fetch,
	initial_fetch,
	subsequent_fetch,
	native_fetch
} from '/node_modules/@sveltejs/kit/src/runtime/client/fetcher.js?v=c4d5c7f4';
import { parse } from '/node_modules/@sveltejs/kit/src/runtime/client/parse.js?v=c4d5c7f4';

import { base } from '/@id/__x00____sveltekit/paths';
import { HttpError, Redirect } from '/node_modules/@sveltejs/kit/src/runtime/control.js?v=c4d5c7f4';
import { stores } from '/node_modules/@sveltejs/kit/src/runtime/client/singletons.js?v=c4d5c7f4';
import { unwrap_promises } from '/node_modules/@sveltejs/kit/src/utils/promises.js?v=c4d5c7f4';
import * as devalue from '/node_modules/.vite/deps/devalue.js?v=c4d5c7f4';
import { INDEX_KEY, PRELOAD_PRIORITIES, SCROLL_KEY, SNAPSHOT_KEY } from '/node_modules/@sveltejs/kit/src/runtime/client/constants.js?v=c4d5c7f4';
import { validate_common_exports } from '/node_modules/@sveltejs/kit/src/utils/exports.js?v=c4d5c7f4';
import { compact } from '/node_modules/@sveltejs/kit/src/utils/array.js?v=c4d5c7f4';
import { validate_depends } from '/node_modules/@sveltejs/kit/src/runtime/shared.js?v=c4d5c7f4';
